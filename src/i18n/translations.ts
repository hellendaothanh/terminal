...
export const translations = {
  vi: {
    ...
    confirmDeleteServer: 'Bạn có chắc chắn muốn xóa máy chủ này khỏi kho dữ liệu?',
    confirmDeleteKey: 'Bạn có chắc chắn muốn xóa SSH Key này?',
    ...
    // AI Assistant Drawer & DevOps Playbook
    aiWelcome: 'Xin chào! Tôi là **Trợ Lý AI OmniTerminal**.\n\nTôi có thể giúp bạn:\n- **Tạo DevOps Playbook đa bước từ ngôn ngữ tự nhiên** kèm Dry-Run & Tự động Rollback.\n- **Phân tích log SSH Terminal** và hướng dẫn các lệnh sửa lỗi Linux.\n- **Tối ưu hóa câu lệnh SQL** và phân tích cấu trúc CSDL.\n\nBấm nút **"📥 Nạp Tự Động Từ Màn Hình Terminal/CSDL"** bên dưới để tôi phân tích dữ liệu trực tiếp!',
    autoCaptureContext: '📥 Nạp Tự Động Từ Màn Hình Terminal / CSDL Hiện Tại',
    inspectServerTelemetry: '🔍 Thu Thập Tình Trạng Máy Chủ (OS, CPU, RAM, Disk, Dịch Vụ)',
    inspectingServer: 'Đang kết nối & thu thập tình trạng máy chủ...',
    capturedContextFrom: '⚡ Đã nạp bối cảnh từ:',
    serverTelemetryTitle: '📊 Thông Tin & Tình Trạng Máy Chủ Thực Tế (OS & Telemetry):',
    includeTelemetryInPrompt: 'Kèm thông số máy chủ vào phân tích AI',
    ...
    tabAiChat: 'Trò Chuyện & Phân Tích',
    tabDevOpsPlaybook: 'DevOps Playbook (NL to Script)',
    playbookTitle: 'Tạo Kịch Bản Tự Động Hóa (Playbook)',
    playbookPromptPlaceholder: 'Ví dụ: Cài đặt Nginx, bật HTTPS Certbot, tạo thư mục web /var/www/site, cấu hình firewall UFW và backup file cũ...',
    generatePlaybookBtn: 'Tạo Playbook Tự Động',
    generatingPlaybook: 'Đang khởi tạo các bước Playbook...',
    selectTargetServer: 'Chọn Máy Chủ Đích',
    dryRunBtn: 'Dry-Run (Kiểm tra mô phỏng)',
    executePlaybookBtn: 'Chạy Kịch Bản (Execute)',
    rollbackAllBtn: 'Hoàn Tác Tất Cả (Rollback)',
    autoRollbackToggle: 'Tự động Rollback nếu xảy ra lỗi',
    exportBash: 'Xuất Bash (.sh)',
    exportAnsible: 'Xuất Ansible (.yml)',
    exportJson: 'Xuất JSON',
    importJson: 'Nhập JSON',
    addStep: 'Thêm Bước Mới',
    stepCommand: 'Lệnh Thực Thi',
    stepCheckCommand: 'Lệnh Kiểm Tra (Dry-Run / Pre-Check)',
    stepRollbackCommand: 'Lệnh Hoàn Tác (Rollback)',
    stepRisk: 'Mức Độ Rủi Ro',
    riskLow: 'Thấp (Low)',
    riskMedium: 'Vừa (Medium)',
    riskHigh: 'Cao (High)',
    riskCritical: 'Nguy Hiểm (Critical)',
    stepStatusPending: 'Chờ chạy',
    stepStatusChecking: 'Đang kiểm tra',
    stepStatusRunning: 'Đang thực thi',
    stepStatusSuccess: 'Thành công',
    stepStatusFailed: 'Thất bại',
    stepStatusRolledBack: 'Đã hoàn tác',
    stepStatusSkipped: 'Bỏ qua',
    stepOutput: 'Terminal Output',
    rollbackInitiated: 'Đã kích hoạt chuỗi Rollback tự động cho các bước trước đó!',
  ...
  en: {
    ...
    confirmDeleteServer: 'Are you sure you want to delete this server from the vault?',
    ...
    // AI Assistant Drawer & DevOps Playbook
    aiWelcome: 'Hello! I am **OmniTerminal AI Assistant**.\n\nI can help you:\n- **Generate Multi-Step DevOps Playbooks from Natural Language** with Dry-Run & Automatic Rollback.\n- **Analyze SSH Terminal logs** and suggest Linux fix commands.\n- **Optimize SQL queries** and analyze database schemas.\n\nClick **"📥 Auto-Capture Live Terminal / DB Context"** below to analyze your screen data!',
    autoCaptureContext: '📥 Auto-Capture Live Terminal / DB Context',
    inspectServerTelemetry: '🔍 Live Server Telemetry (OS, CPU, RAM, Disk, Services)',
    inspectingServer: 'Connecting & gathering live server telemetry...',
    capturedContextFrom: '⚡ Context loaded from:',
    serverTelemetryTitle: '📊 Real-Time Server State (OS & Telemetry):',
    includeTelemetryInPrompt: 'Include live server stats in AI analysis',
    ...
    tabAiChat: 'Chat & Diagnostics',
    tabDevOpsPlaybook: 'DevOps Playbook (NL to Script)',
    playbookTitle: 'Natural Language DevOps Playbook Generator',
    playbookPromptPlaceholder: 'e.g. Install Nginx, enable Certbot SSL, create web folder /var/www/site, configure UFW firewall and backup existing config...',
    generatePlaybookBtn: 'Generate Playbook',
    generatingPlaybook: 'Generating multi-step playbook...',
    selectTargetServer: 'Select Target Server',
    dryRunBtn: 'Dry-Run (Pre-Check)',
    executePlaybookBtn: 'Execute Playbook',
    rollbackAllBtn: 'Rollback Completed Steps',
    autoRollbackToggle: 'Auto-Rollback on failure',
    exportBash: 'Export Bash (.sh)',
    exportAnsible: 'Export Ansible (.yml)',
    exportJson: 'Export JSON',
    importJson: 'Import JSON',
    addStep: 'Add New Step',
    stepCommand: 'Execution Command',
    stepCheckCommand: 'Check Command (Dry-Run / Pre-Check)',
    stepRollbackCommand: 'Rollback / Undo Command',
    stepRisk: 'Risk Level',
    riskLow: 'Low',
    riskMedium: 'Medium',
    riskHigh: 'High',
    ...
    stepStatusChecking: 'Checking',
    stepStatusRunning: 'Running',
    stepStatusSuccess: 'Success',
    stepStatusFailed: 'Failed',
    stepStatusRolledBack: 'Rolled Back',
    stepStatusSkipped: 'Skipped',
    stepOutput: 'Terminal Output',
    rollbackInitiated: 'Automatic rollback chain triggered for completed steps!',
